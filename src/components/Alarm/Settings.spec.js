...
describe('Settings', () => {
    ...
    it('sets the alarm days', async () => {
        ...
        const tuesday = wrapper.find(
            '[data-testid="days"] label:nth-child(2) input'
        )
        const saturday = wrapper.find(
            '[data-testid="days"] label:nth-child(6) input'
        )
    ...
    it('sets the snooze minutes', async () => {
        ...
        await wrapper
            .find('[data-testid="snoozeMinutes"]')
            .find('[data-testid="increment"]')
            .trigger('click')
